...
<p align="center">
  <img src="image/padim_localization_heatmap.png" width="60%">
</p>

_Figure 1: Example of an anomaly localization heatmap generated by our pipeline, successfully identifying a subtle defect on a highly specular metal surface._
...
![Anomaly Localization Heatmap](image/photometric_method.png)
...
<p align="center">
  <img src="image/3d_cad_setup.png" width="60%">
</p>

_Figure 3: The custom 12-directional LED dome lighting setup utilized for the Photometric Stereo acquisition process._
...
<p align="center">
  <img src="image/chrome_calibration.png" width="100%">
</p>

_Figure 4: Light source calibration using a reference chrome sphere. (Left) A sequence of captured images showing the detection of specular highlights (red crosses) and the computed 2D projection of the light vectors (yellow arrows) under varying illumination. (Right) A 3D spatial visualization of the fully estimated light direction vectors mapped onto a hemisphere._

<p align="center">
  <img src="image/image_comparison.png" width="100%">
</p>

_Figure 5: Comparison of output maps. (a) Raw 2D image. (b) Albedo Map showing intrinsic texture. (c) Normal X Map highlighting topographical defect boundaries. (d) Complete RGB Normal Map showing 3D surface orientation._
