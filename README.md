...
_Figure 2: Photometric Stereo method with with 12 directional illumination setup_
...
_Figure 2: The custom 12-directional LED dome lighting setup utilized for the Photometric Stereo acquisition process._

![Photometric Stereo Pipeline Results](image/photometric_results.png)
_Figure 3: Comparison of Raw Input Images (top) and the Computed Normal Maps (bottom). The Normal Map successfully suppresses specular noise, isolating the actual surface geometry._
